...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#template-navbar">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <ul id="menu-pricing" class="menu-price">
                                ...
                                <li class="item" id="{{$item->category->slug}}">
                                    <a href="#">
                                        <img src="{{asset('uploads/item/'.$item->image)}}" class="img-responsive" alt="Food" style="height: 150px; width:350px;" >
                                ...
                                <form class="reservation-form" method="post" action="{{ route('reservation.store')}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control reserve-form empty iconified" name="datepicker" id="datetimepacker1"  placeholder="&#xf017;  Time">
                                            </div>
                                        </div>
        ...
        <script>
            $(function(){
                $('#datetimepacker1').datetimepicker({
